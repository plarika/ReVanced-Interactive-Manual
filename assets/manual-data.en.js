window.MANUAL_DATA = {
  ...
  "sources": [
    ...
    {
      "id": "R25",
      "name": "ReVanced Patcher issue #446 — Android 17: background audio hardening may silence background playback",
  ...
  "currentReports": [
    ...
    },
    {
      ...
      "summary": "Official issue #3511 reports that playback on YouTube Music can start normally and, after about 1 minute, go wrong/buffering and stop continuing; at least two additional users confirmed similar behavior. The author's debug log shows Spoof video streams to use ANDROID REEL NO AUTH. One user reported temporary improvement when switching the Default client to visionOS, but there is no upstream confirmation of cause or universal correction. Official ReVanced/GmsCore issue #381, updated on 2026-09-05, adds several independent reports of the same pattern in YouTube Music and YouTube; three users report that changing only the Default client to Android VR resolved the ~1-minute stall. However, a later 2026-09-05 report in the same issue says Android VR did not solve it on another device; that user temporally associated the onset with a GmsCore/microG update, without sufficient evidence to assign causality. This keeps Android VR as a reproduced but contradictory, non-universal community workaround. On 2026-09-06, a later comment in issue #3511 said the visionOS workaround no longer worked in that case; another user separately reported \"Could not fetch any client streams\" on \"for kids\" content. These two points remain isolated reports and do not confirm a new cause, scope, or fix.",
      "action": "Register YouTube Music, Manager and patches versions and test the same content for at least 3 minutes. Test A/B changing only the Default client of Spoof video streams, fully restarting the app between tests. visionOS should be treated as a transient and now contradictory workaround: a later report says it stopped working. If tested, keep every other variable unchanged and return to baseline if there is no improvement or if behavior regresses. Preserve debug logs and do not assign the problem to the network, account or GMSCore without further evidence. Android VR has multiple confirmations in official GmsCore issue #381, but also at least one failure report; it can be prioritized as an A/B test, never as a fix, while keeping every other variable unchanged.",
    ...
    {
      "issue": 2962,
      "title": "YouTube Music on Android Auto: crash, infinite loading or blank screens; maintainer points to current GmsCore pre-release",
    ...
    {
      "issue": 446,
      "title": "Android 17: background audio may stop after locking the screen or switching apps",
      "state": "OPEN",
      "reported": "2026-06-17",
      "classification": "REPORTED / TECHNICAL EVIDENCE",
      "evidence": "Medium",
